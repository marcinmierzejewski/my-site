...
export const Skills = () => {
  return (
    <IconsSkills>
      <li><img src={IconHtml} alt="html" /></li>
      <li><img src={IconCss} alt="css" /></li>
      <li><img src={IconSass} alt="sass" /></li>
      <li><img src={IconJavascript} alt="javascript" /></li>
      <li><img src={IconReact} alt="react" /></li>
      <li><img src={IconNode} alt="nodejs" /></li>
    </IconsSkills>
  )
}